...
INSERT INTO string_key_table VALUES (default, 'length in cm');
INSERT INTO string_key_table VALUES (default, 'goal');
INSERT INTO string_key_table VALUES (default, 'substrate', NOW());
INSERT INTO string_key_table VALUES (default, 'cell length', NOW());
INSERT INTO string_key_table VALUES (default, 'weight', NOW());
INSERT INTO string_key_table VALUES (default, 'weight of something', NOW());
INSERT INTO string_key_table VALUES (default, 'base parameters', NOW());
INSERT INTO string_key_table VALUES (default, 'measurements', NOW());
INSERT INTO string_key_table VALUES (default, 'glass', NOW());
INSERT INTO string_key_table VALUES (default, 'polyimide', NOW());
INSERT INTO string_key_table VALUES (default, 'steel foil', NOW());
INSERT INTO string_key_table VALUES (default, 'cm', '5.6.2015');
INSERT INTO string_key_table VALUES (default, 'g', '5.6.2015');
INSERT INTO string_key_table VALUES (default, 'improve VOC', NOW());
INSERT INTO string_key_table VALUES (default, 'washing', NOW());
INSERT INTO string_key_table VALUES (default, 'pre-wash', NOW());
INSERT INTO string_key_table VALUES (default, 'main-wash', NOW());
INSERT INTO string_key_table VALUES (default, 'worker', NOW());
INSERT INTO string_key_table VALUES (default, 'worker', NOW());
INSERT INTO string_key_table VALUES (default, 'basic data', NOW());
INSERT INTO string_key_table VALUES (default, 'Standard-Glas-substrate', NOW());
INSERT INTO string_key_table VALUES (default, 'first experiment', NOW());
...
INSERT INTO string_key_table VALUES (default, 'comment for process');
INSERT INTO string_key_table VALUES (default, 'standard-cleaning');
INSERT INTO string_key_table VALUES (default, 'experiment number');
INSERT INTO string_key_table VALUES (default, 'description for experiment number');
INSERT INTO string_key_table VALUES (default, 'sputtering with 2 layers');
INSERT INTO string_key_table VALUES (default, 'nice solar cell');
...
INSERT INTO string_key_table VALUES (default, 'Coating processes');
INSERT INTO string_key_table VALUES (default, 'Deadline');
INSERT INTO string_key_table VALUES (default, 'Description Deadline');
INSERT INTO string_key_table VALUES (default, 'Description Goal');
INSERT INTO string_key_table VALUES (default, 'a single solarcell');
INSERT INTO string_key_table VALUES (default, 'an amount of powder');
INSERT INTO string_key_table VALUES (default, 'solar samples');
INSERT INTO string_key_table VALUES (default, 'powder sample');
...
INSERT INTO stringtable VALUES (default,  1, 'de', 'Status', NOW());
...
--   description	    INTEGER NOT NULL REFERENCES string_key_table(ID),
--   format          VARCHAR (20),
--   regex           VARCHAR (200),
...
INSERT INTO samples (ObjecttypesID, Creator, lastUser) VALUES (1, 1, 1); -- Solarzelle1
INSERT INTO samples (ObjecttypesID, Creator, lastUser) VALUES (1, 1, 1); -- Solarzelle2
INSERT INTO samples (ObjecttypesID, Creator, lastUser) VALUES (2, 1, 1); -- Pulver 1
INSERT INTO samples (ObjecttypesID, Creator, lastUser) VALUES (2, 1, 1); -- Pulver 2
...
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (1, 1, '{"value":4711}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser)
	   VALUES (1, 2, '{"value":10}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (2, 1, '{"value":4711}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (2, 2, '{"value":11}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (3, 7, '{"value":815}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (3, 8, '{"value":1}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (4, 7, '{"value":815}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (4, 8, '{"value":2}',1);
-- measurements:
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (1, 3, '{"value":30.55, "error":0.5}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (2, 3, '{"value":31.01, "error":0.4}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (3, 9, '{"value":32.67, "error":0.2}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (4, 9, '{"value":31.98, "error":0.6}',1);
-- floats:
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (1, 5, '{"value":0.043}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (1, 6, '{"value":19.1}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (2, 6, '{"value":15.2}',1);
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
	   VALUES (2, 5, '{"value":0.045}',1);
-- strings:
INSERT INTO sampledata (ObjectID,Ot_Parameter_ID,Data,lastUser) 
 		VALUES (1, 4, '{"value":"Glas"}',1);



INSERT INTO originates_from VALUES (default,1,2,NOW());
INSERT INTO originates_from VALUES (default,3,2,NOW());
INSERT INTO originates_from VALUES (default,4,1,NOW());
-- ID 				      INTEGER NOT NULL PRIMARY KEY, -- for editing
-- Parent 			    INTEGER NOT NULL REFERENCES objects(ID), -- Objekte
-- Child 		     	INTEGER NOT NULL REFERENCES objects(ID)
-- lastChange      timestamp
...
INSERT INTO groups VALUES (default,'Admins',NOW());
INSERT INTO groups VALUES (default,'Scientists',NOW());
INSERT INTO groups VALUES (default,'Technicians',NOW());
-- CREATE TABLE groups(
--   ID              INTEGER NOT NULL PRIMARY KEY, 
--   Name            VARCHAR(200),
--   lastChange      timestamp
...
INSERT INTO processtypegroups VALUES (default, 1, 54);
-- CREATE TABLE processtypegroups (
--   ID              SERIAL PRIMARY KEY, 
--   position        INTEGER,
--   name            INTEGER NOT NULL REFERENCES string_key_table,
--   lastChange      TIMESTAMP,
--   lastUser        INTEGER REFERENCES users(ID)
-- );
...
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   PT_ID           INTEGER NOT NULL REFERENCES processtypes(ID),
--   StringKey       INTEGER NOT NULL REFERENCES string_key_table(ID),
--   pos             INTEGER NOT NULL,
--   lastChange      timestamp
...
-- Technicians can do the cleaning
INSERT INTO rightsprocesstypegroup (groupID,processtype,permission,lastUser) VALUES (3,1,'w',1); 
INSERT INTO rightsprocesstypegroup (groupID,processtype,permission,lastUser) VALUES (3,2,'r',1); 


-- Scientist can do cleaning and sputtering
INSERT INTO rightsprocesstypegroup (groupID,processtype,permission,lastUser) VALUES (2,1,'w',1);  
INSERT INTO rightsprocesstypegroup (groupID,processtype,permission,lastUser) VALUES (2,2,'w',1);  
...
-- CREATE TABLE processrightsusers(
--   ID              INTEGER NOT NULL PRIMARY KEY, 
--   userID          INTEGER NOT NULL REFERENCES users(ID),
--   processID       INTEGER NOT NULL, -- REFERENCES processID(ID),  
--   lastChange      timestamp 

-- CREATE TABLE filerightsgroups( -- 
--   ID              INTEGER NOT NULL PRIMARY KEY, 
--   groupID         INTEGER NOT NULL REFERENCES groups(ID),
...
INSERT INTO rightssampletypegroup (groupID,sampletype,permission,lastUser) VALUES (2,1,'w',1);  
INSERT INTO rightssampletypegroup (groupID,sampletype,permission,lastUser) VALUES (3,1,'r',1);
INSERT INTO rightssampletypegroup (groupID,sampletype,permission,lastUser) VALUES (2,2,'w',1);
INSERT INTO rightssampletypegroup (groupID,sampletype,permission,lastUser) VALUES (3,2,'w',1);
-- group2 (Scientists) can do everything with solar cells
--   ID              SERIAL PRIMARY KEY, 
--   groupID         INTEGER NOT NULL REFERENCES groups(ID) ON DELETE CASCADE,
--   sampleID        INTEGER NOT NULL REFERENCES samples(ID) ON DELETE CASCADE,  
--   lastChange      TIMESTAMP,
--   lastUser        INTEGER REFERENCES users(ID)
...
INSERT INTO processes VALUES (default,1,NOW(),1); 
INSERT INTO processes VALUES (default,1,NOW(),1); 
INSERT INTO processes VALUES (default,1,NOW(),1); 
INSERT INTO processes VALUES (default,2,NOW(),1); 
INSERT INTO processes VALUES (default,2,NOW(),1); 
...
INSERT INTO processdata (ProcessID, ParameterID, Data, lastUser) 
		VALUES (2, 8, '{"value":2.2222}', 1);
INSERT INTO processdata (ProcessID, ParameterID, Data, lastUser) 
		VALUES (3, 8, '{"value":3.3333}', 1);
-- Strings
INSERT INTO processdata (ProcessID, ParameterID, Data, lastUser) 
...
INSERT INTO processdata (ProcessID, ParameterID, Data, lastUser) 
		VALUES (2, 2, '{"tz":-120,"date":"2016-05-30T17:14:33.633Z"}',1);
INSERT INTO processdata (ProcessID, ParameterID, Data, lastUser) 
...
INSERT INTO samplesinprocess VALUES (default,1,1,NOW(),1);
INSERT INTO samplesinprocess VALUES (default,1,2,NOW(),1);
INSERT INTO samplesinprocess VALUES (default,2,3,NOW(),1);
INSERT INTO samplesinprocess VALUES (default,2,2,NOW(),1);
-- CREATE TABLE samplesinprocess (
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   ProcessID       INTEGER NOT NULL REFERENCES processes(ID),
...
-- CREATE TABLE po_data ( -- single parameter data
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   OPID            INTEGER NOT NULL REFERENCES samplesinprocess(ID),
--   PO_Parameter_ID INTEGER NOT NULL REFERENCES po_parameters,
--   IValue          INTEGER,
--   FValue1         DOUBLE PRECISION,
--   FValue2         DOUBLE PRECISION,
--   lastChange      timestamp

-- CREATE TABLE po_string_data (  -- data for String parameters
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   OPID            INTEGER NOT NULL REFERENCES samplesinprocess(ID),
--   PO_Parameter_ID INTEGER NOT NULL REFERENCES po_parameters,
--   StringKey       INTEGER NOT NULL REFERENCES string_key_table(ID),
...
-- CREATE TABLE o_searchdata ( -- single parameter data
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   searchobject    INTEGER NOT NULL REFERENCES searchObject(ID),
--   IValue          INTEGER NOT NULL,
--   FValue          DOUBLE PRECISION,
--   fromOrTo        BOOLEAN, -- True: From
--   lastChange      timestamp

INSERT INTO searchProcess (search,pparameter,comparison,value) VALUES (2,8,2,'10.1');
...
-- CREATE TABLE p_searchdata ( -- single parameter data
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   ProcessID       INTEGER NOT NULL REFERENCES searchProcess(ID),
--   IValue          INTEGER,
--   FValue          DOUBLE PRECISION,
--   fromOrTo        BOOLEAN, -- True: From  
--   lastChange      timestamp

-- CREATE TABLE searchPO (  -- Search requests objectspecific data in processes
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   search          INTEGER NOT NULL REFERENCES searches(ID),
--   PO_Parameter_ID INTEGER NOT NULL REFERENCES po_parameters(ID),
--   lastChange      timestamp


INSERT INTO oSearchOutput (search,position,otparameter) VALUES (1,1,1);
INSERT INTO oSearchOutput (search,position,otparameter) VALUES (1,2,2);
INSERT INTO oSearchOutput (search,position,otparameter) VALUES (1,3,3);
INSERT INTO oSearchOutput (search,position,otparameter) VALUES (1,4,4);
INSERT INTO oSearchOutput (search,position,otparameter) VALUES (1,5,5);
INSERT INTO oSearchOutput (search,position,otparameter) VALUES (1,6,6);
...
-- CREATE TABLE po_searchdata ( -- single parameter data
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   ProcessID       INTEGER NOT NULL REFERENCES searchProcess(ID),
--   IValue          INTEGER,
--   FValue          DOUBLE PRECISION,
...
-- CREATE TABLE o_search_result (
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   search          INTEGER NOT NULL REFERENCES searches(ID),
--   O_Parameter_ID  INTEGER NOT NULL REFERENCES ot_parameters(ID),
--   lastChange      timestamp

-- CREATE TABLE p_search_result (
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   search          INTEGER NOT NULL REFERENCES searches(ID),
--   P_Parameter_ID  INTEGER NOT NULL REFERENCES po_parameters(ID),
--   lastChange      timestamp

-- CREATE TABLE po_search_result (
--   ID              INTEGER NOT NULL PRIMARY KEY,
--   ProcessID       INTEGER NOT NULL REFERENCES searchProcess(ID),
--   PO_Parameter_ID INTEGER NOT NULL REFERENCES po_parameters(ID),
--   lastChange      timestamp
...
--   ID              SERIAL PRIMARY KEY,
--   exp_plan_id     INTEGER NOT NULL REFERENCES exp_plan(ID) ON DELETE CASCADE,
--   hidden          BOOLEAN,
--   Formula         VARCHAR(250),
--   pos             INTEGER NOT NULL,
--   definition      INTEGER NOT NULL REFERENCES paramdef(ID),
...
INSERT INTO experimentdata (ExperimentID, ParameterID, Data, lastUser) 
		VALUES (1, 2, '{"value":20.55, "error":0.4}',1);
INSERT INTO experimentdata (ExperimentID, ParameterID, Data, lastUser) 
		VALUES (1, 1, '{"value":"Erhöhung des Wirkungsgrades"}',1);
INSERT INTO experimentdata (ExperimentID, ParameterID, Data, lastUser) 
...
--   ID              SERIAL PRIMARY KEY,
--   position        INTEGER,
--   note            INTEGER REFERENCES string_key_table(ID) ON DELETE CASCADE,
--   expp_ID         INTEGER NOT NULL REFERENCES exp_plan(ID) ON DELETE CASCADE,
...
INSERT INTO exp_plan_processes VALUES (default,1,1,1,1,   NULL,NOW(),1);
INSERT INTO exp_plan_processes VALUES (default,2,1,2,NULL,NULL,NOW(),1);
INSERT INTO exp_plan_processes VALUES (default,1,2,1,NULL,NULL,NOW(),1); -- washing, experiment:2(bzw5), 
...
--   recipe          INTEGER REFERENCES P_recipes(ID),
