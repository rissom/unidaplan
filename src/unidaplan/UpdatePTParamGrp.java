...
import org.json.JSONObject;
	...
	public class UpdatePTParamGrp extends HttpServlet {
	...
	@Override
	  public void doPut(HttpServletRequest request, HttpServletResponse response)
	    ...
	    try {
			...
			System.err.println("UpdatePTParamGrp: Input is not valid JSON");
		}
	    ...
	    try {
			...
			System.err.println("UpdatePTParamGrp: Error parsing ID-Field or comment");
